			...
			<form onSubmit={register}>
				<div className="form-group">
					...
					<input
						...
						required
					/>
					<small className="form-text text-danger">{error.username?.message}</small>
				</div>
				<div className="form-group">
					...
					<input
						...
						required
					/>
					<small className="form-text text-danger">{error.password?.message}</small>
				</div>
				<div className="form-group">
					...
					<input
						...
						required
					/>
					<small className="form-text text-danger">{error.pwdConfirm?.message}</small>
				</div>
